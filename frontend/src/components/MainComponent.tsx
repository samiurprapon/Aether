...
const MainContent: React.FC<MainContentProps> = ({ isDarkMode }) => {
  return (
    <main className={`flex flex-col-reverse md:flex-row items-center justify-between p-4 md:p-8 space-y-8 md:space-y-0 md:space-x-8 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      {/* Text Content */}
