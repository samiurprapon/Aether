	...
	const Navlinks: NavLinkItem[] = [
		{
			...
			icon: (
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path
						d="M14.9245 3.12014H7.65676C4.64532 3.12014 2.77805 5.25286 2.77805 8.2643V16.3467C2.77805 19.3581 4.60871 21.4817 7.65676 21.4817H16.2609C19.2723 21.4817 21.1396 19.3581 21.1396 16.3467V9.30778"
						stroke="white"
						stroke-width="1.5"
						stroke-linecap="round"
						stroke-linejoin="round"
		...
		},
		{
			...
			icon: (
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
						d="M17 12.899V22L12 19L7 22V12.898"
						stroke="#A3A3A5"
						stroke-width="1.5"
						stroke-miterlimit="10"
						stroke-linecap="round"
		...
		},
		{
			...
			icon: (
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					/>
					<path
						d="M21 14.6786V21L18.4286 20.1428L15.8571 21V14.6786"
						stroke="#A3A3A5"
						stroke-width="1.5"
						stroke-miterlimit="10"
						stroke-linecap="round"
